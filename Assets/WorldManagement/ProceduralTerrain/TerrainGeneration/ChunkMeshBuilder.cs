...
namespace WorldManagement.TerrainGeneration
{
	...
	public class ChunkMeshBuilder
	{
		...
		// --- System ---
		private TerrainChunkGenerator m_worldBuilder;
		...
		public ChunkMeshBuilder(TerrainChunkGenerator chunkGenerator)
		{
			m_worldBuilder = chunkGenerator;
			...
			chunkGenerator.StartCoroutine(MeshFromQueue());
		}
